...
IndonesiaApp
    .controller('homeWhsCtrl', function ($http, $scope, $timeout, menuData, $base64, getApi, $rootScope, getDataService) {
        //echarts
        /*$scope.option = {
            title: {
                text: 'SR QTY'
        ...
        getDataService.data(
            ...
            function (response) {
               ...
               /* $scope.srKpi = response.sr_month
                ...
                $('#rtat').speedometer({percentage: $scope.homepage.rtat || 0});*/
                ...
                $('#rtat3').speedometer2({percentage: $scope.homepage.scr_rtat || 0});
